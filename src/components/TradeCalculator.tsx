...
export function TradeCalculator() {
  ...
  const EmptySlot = ({ onClick }: { onClick: () => void }) => (
    <div
      onClick={onClick}
      className="w-24 h-24 md:w-32 md:h-32 bg-blue-800/30 rounded-lg flex items-center justify-center cursor-pointer hover:bg-blue-800/40 transition-colors"
    >
  ...
  const FilledSlot = ({ item, onRemove }: { item: Item; onRemove: () => void }) => (
    <div className="w-24 h-24 md:w-32 md:h-32 bg-gray-700 rounded-lg p-2 relative group">
